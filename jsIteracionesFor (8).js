...
function Mostrar()
{
	...
	while(respuesta == true)
	{
		...
		//sexo
		alSexo = prompt("ingrese el sexo");
		
		
					//DESARROLLAR
		//1. cantidad de mujeres aprobadas mayores a 25 años

		if(alSexo == "f" || alSexo != "F")
		{
			if(alEdad>25 && alNota > 3)
				ContMujeres25NA++;
	...
	document.write("nota maxima: "+max+"</br>promedio de las notas: "+promedioNota+"</br>Cantidad de mujeres de 25 años: "+ContMujeres25NA);
